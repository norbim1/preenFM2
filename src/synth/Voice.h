...
public:
    ...
    void updateAllMixOscsAndPans() {
        ...
        float pan1 = currentTimbre->getParamRaw()->engineMix1.panOsc1 + matrix.getDestination(PAN_OSC1) + matrix.getDestination(ALL_PAN) + currentTimbre->getMidiPan() + 1.0f;
        ...
        float pan2 = currentTimbre->getParamRaw()->engineMix1.panOsc2 + matrix.getDestination(PAN_OSC2) + matrix.getDestination(ALL_PAN) + currentTimbre->getMidiPan() + 1.0f;
        ...
        float pan3 = currentTimbre->getParamRaw()->engineMix2.panOsc3 + matrix.getDestination(PAN_OSC3) + matrix.getDestination(ALL_PAN) + currentTimbre->getMidiPan() + 1.0f;
        ...
        float pan4 = currentTimbre->getParamRaw()->engineMix2.panOsc4 + matrix.getDestination(PAN_OSC4) + matrix.getDestination(ALL_PAN) + currentTimbre->getMidiPan() + 1.0f;
        ...
        float pan5 = currentTimbre->getParamRaw()->engineMix3.panOsc5 + matrix.getDestination(ALL_PAN)  + currentTimbre->getMidiPan() + 1.0f;
        ...
        float pan6 = currentTimbre->getParamRaw()->engineMix3.panOsc6 + matrix.getDestination(ALL_PAN) + currentTimbre->getMidiPan() + 1.0f;
